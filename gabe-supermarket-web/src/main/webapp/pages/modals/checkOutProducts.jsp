<div class="modal-header">
    <h3 class="modal-title" id="modal-title">Payment Option</h3>
</div>
                        ...
                        <div class="x_content">
                            ...
                            <form id="referralForm" class="form-horizontal form-label-left">
                                <div class="form-group">     
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <button class="btn btn-primary" type="button">Wallet</button>
                                        <button class="btn btn-primary" type="button">Loyalty points</button>   
                                        <button class="btn btn-warning" type="button">Bank/Credit Card</button>   
                                    </div>
                                </div> 
                            </form>
