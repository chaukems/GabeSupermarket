...
var Color = function (obj) {
    ...
    if (typeof obj === 'string') {
        ...
        if (vals.r !== undefined || vals.red !== undefined) {
            ...
            throw new Error('Unable to parse color from object ' + angular.toJson(obj));
        }
    }
};
...
function rgb2keyword(rgb) {
  return reverseKeywords[angular.toJson(rgb)];
}
...
for (var key in cssKeywords) {
  reverseKeywords[angular.toJson(cssKeywords[key])] = key;
}
